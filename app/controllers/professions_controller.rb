class ProfessionsController < ApplicationController
  ...
  def index
   #  @professions = Profession.all
    ...
    @title=t('definition').pluralize.mb_chars.upcase+" | "+t('activerecord.models.profession').pluralize.capitalize
  ...
  def new
    ...
    @title=t('definition').pluralize.mb_chars.upcase+" | "+t('activerecord.models.profession').pluralize.capitalize+' | '+t('actions.new.f')
  ...
  def edit
    	...
    	@title=t('definition').pluralize.mb_chars.upcase+" | "+t('activerecord.models.profession').capitalize+' | '+t('actions.edit')
...
#         format.html { redirect_to @profession, notice: 'Profession was successfully created.' }
  ...
  private
    ...
    def profession_params
      params.require(:profession).permit(:name, :occupationcode, :pap, :medres, :professionalfamily_id)
    end
end
