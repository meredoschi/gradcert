...
ActiveSupport::Inflector.inflections(:pt_BR) do |inflect|
  ...
  inflect.irregular 'tipo de instituição de ensino superior',
...
ActiveSupport::Inflector.inflections(:en) do |inflect_en|
  # International version
  inflect_en.irregular 'family of professions', 'families of professions'
end
