  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved roster as @roster" do
        post :create, {:roster => invalid_attributes}, valid_session
        expect(assigns(:roster)).to be_a_new(Roster)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested roster" do
        roster = Roster.create! valid_attributes
        put :update, {:id => roster.to_param, :roster => new_attributes}, valid_session
        roster.reload
    ...
    context "with invalid params" do
      it "assigns the roster as @roster" do
        roster = Roster.create! valid_attributes
        put :update, {:id => roster.to_param, :roster => invalid_attributes}, valid_session
        expect(assigns(:roster)).to eq(roster)
      end
