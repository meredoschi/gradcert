...
RSpec.describe ProfessionsController, :type => :controller do
  ...
  # Profession. As you add validations to Profession, be sure to
  ...
  # ProfessionsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET show" do
    it "assigns the requested profession as @profession" do
      profession = Profession.create! valid_attributes
      get :show, {:id => profession.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested profession as @profession" do
      profession = Profession.create! valid_attributes
      get :edit, {:id => profession.to_param}, valid_session
      expect(assigns(:profession)).to eq(profession)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Profession" do
        expect {
          post :create, {:profession => valid_attributes}, valid_session
      ...
      it "redirects to the created profession" do
        post :create, {:profession => valid_attributes}, valid_session
        expect(response).to redirect_to(Profession.last)
      end
    end

    describe "with invalid params" do
      it "assigns a newly created but unsaved profession as @profession" do
        post :create, {:profession => invalid_attributes}, valid_session
        expect(assigns(:profession)).to be_a_new(Profession)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested profession" do
        profession = Profession.create! valid_attributes
        put :update, {:id => profession.to_param, :profession => new_attributes}, valid_session
        profession.reload
      ...
      it "assigns the requested profession as @profession" do
        profession = Profession.create! valid_attributes
        put :update, {:id => profession.to_param, :profession => valid_attributes}, valid_session
        expect(assigns(:profession)).to eq(profession)
      end
      ...
      it "redirects to the profession" do
        profession = Profession.create! valid_attributes
        put :update, {:id => profession.to_param, :profession => valid_attributes}, valid_session
        expect(response).to redirect_to(profession)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the profession as @profession" do
        profession = Profession.create! valid_attributes
        put :update, {:id => profession.to_param, :profession => invalid_attributes}, valid_session
        expect(assigns(:profession)).to eq(profession)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested profession" do
      profession = Profession.create! valid_attributes
      expect {
        delete :destroy, {:id => profession.to_param}, valid_session
      }.to change(Profession, :count).by(-1)
    end
