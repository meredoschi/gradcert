  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested institution" do
        institution = Institution.create! valid_attributes
        put :update, {:id => institution.to_param, :institution => new_attributes}, valid_session
        institution.reload
    ...
    describe "with invalid params" do
      it "assigns the institution as @institution" do
        institution = Institution.create! valid_attributes
        put :update, {:id => institution.to_param, :institution => invalid_attributes}, valid_session
        expect(assigns(:institution)).to eq(institution)
      end
