...
FactoryBot.define do
  factory :personalinfo do
    ...
    sequence(:tin) { |n| Brazilianbanking.generate_cpf((100_000_000 + n).to_s).to_s }
    sequence(:idnumber) { |n| (10_000 + n).to_s.to_s }
    sex 'F'
    state_id 1

    trait :with_mothers_name_and_ssn do
      sequence(:socialsecuritynumber) { |n| Brazilianbanking.generate_nit((1_000_000_020 + n).to_s).to_s }
