...
FactoryBot.define do
  factory :feedback do
    #    Feedback(id: integer, registration_id: integer, processingdate: date, approved: boolean,
    #    payroll_id: integer, processed: boolean, bankpayment_id: integer, comment: string)
