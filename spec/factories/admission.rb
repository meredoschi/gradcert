...
FactoryBot.define do
  factory :admission do
    # Admission(id: integer, start: date, candidates: integer, absentfirstexam: integer, absentfinalexam: integer, passedfirstexam: integer, appealsdeniedfirstexam: integer, appealsgrantedfirstexam: integer, admitted: integer, convoked: integer, finish: date,  program_id: integer)

#    program_id 1
    sequence(:program_id) {|n| "#{n}" }
