...
RSpec.describe "programsituations/new", :type => :view do
  before(:each) do
    assign(:programsituation, Programsituation.new(
      :assesment_id => 1,
  ...
  it "renders new programsituation form" do
    render

    assert_select "form[action=?][method=?]", programsituations_path, "post" do
