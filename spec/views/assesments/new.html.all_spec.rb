...
RSpec.describe "assesments/new", :type => :view do
  before(:each) do
    assign(:assesment, Assesment.new(
      :contact_id => 1,
      :program_id => 1,
      :profession_id => 1,
  ...
  it "renders new assesment form" do
    render

    assert_select "form[action=?][method=?]", assesments_path, "post" do
